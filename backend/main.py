...
from backend.api.routers import events, health, matches, patients, resources
...
for router in (health.router, resources.router, patients.router, matches.router, events.router):
